...
export default async function Navbar() {
    return (
        <div className="flex flex-col bg-[#2C2C2C] rounded-lg p-4">

            <Link href="/" className=' flex p-4 w-[100%] font-inter font-medium rounded-lg text-2xl mb-2 hover:bg-[#353535] hover:font-bold'>
            ...
            <Link href="/news" className=' flex p-4 w-[100%] font-inter font-medium rounded-lg text-2xl my-2 hover:bg-[#353535] hover:font-bold'>
                <li className='flex flex-row gap-4 items-center'>
            ...
            <Link href="/tournaments" className=' flex p-4 w-[100%] font-inter font-medium rounded-lg text-2xl my-2 hover:bg-[#353535] hover:font-bold'>
                <li className='flex flex-row gap-4 items-center'>
            ...
            <Link href="/matches" className=' flex p-4 w-[100%] font-inter font-medium rounded-lg text-2xl my-2 hover:bg-[#353535] hover:font-bold'>
                <li className='flex flex-row gap-4 items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="1 1 22 22" fill="none">
            ...
            <Link href="/players" className=' flex p-4 w-[100%] font-inter font-medium rounded-lg text-2xl mt-2 hover:bg-[#353535] hover:font-bold'>
                <li className='flex flex-row gap-4 items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
